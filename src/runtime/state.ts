...
export const transitions: Record<RunState, RunState[]> = {
  preflight: ['baseline', 'paused', 'cancelled'], baseline: ['plan_setup', 'paused', 'cancelled'], plan_setup: ['executing', 'paused', 'cancelled'], executing: ['validating', 'paused', 'cancelled'], validating: ['reviewing', 'paused', 'cancelled'], reviewing: ['repairing', 'integrating', 'paused', 'cancelled'], repairing: ['executing', 'integrating', 'paused', 'cancelled'], integrating: ['complete', 'paused', 'cancelled'], complete: [], paused: ['preflight', 'baseline', 'plan_setup', 'executing', 'validating', 'reviewing', 'repairing', 'integrating', 'cancelled'], cancelled: []
};

...
describe('core utilities', () => {
  ...
  it('keeps Researcher from searching repositories or mutating Git', () => { expect(validateRoleCommand('researcher', 'rg pattern src')).toMatch(/web research/); expect(validateRoleCommand('researcher', 'git commit -m x')).toMatch(/web research/); });

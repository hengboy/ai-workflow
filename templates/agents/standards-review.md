...
- ADR/index consistency: every architecture-level decision is captured in an ADR, every `MEMORY.md` reference agrees with its ADR, and `.ai-workflow/adr/INDEX.md` matches the ADR headers.

...
- `MEMORY.md` holds current standards (how) while ADRs hold decision history (why); update both in the same change and reference the `ai-workflow adr list` command.
...
- Review depth should match task risk; reviews are collaboration guidance, not mandatory gates.
